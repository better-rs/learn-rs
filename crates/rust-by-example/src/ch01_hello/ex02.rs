...
fn ex02_01_debug() {
    ...
    println!("person: {:#?}, name:{}, age:{}", perter, perter.name, perter.age,);
}
...
fn ex02_02_display() {
    ...
    println!("big range: {big}, small range: {small}", big = big_range, small = small_range);
...
fn ex02_04_fmt() {
    ...
    .iter()
    {
        println!("color: {:?}, ({}, {}, {})", *color, color.red, color.green, color.blue);
    }
}
